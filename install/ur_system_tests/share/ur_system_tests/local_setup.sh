...
: ${AMENT_CURRENT_PREFIX:="/home/darsh/UR_GRIPPER/install/ur_system_tests"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ur_system_tests/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ur_system_tests/environment/path.sh"
